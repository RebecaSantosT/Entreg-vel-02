function contador(){
    ...
    var quantidadeNotas = Number( prompt ('Informe a quantidade de notas'));
    var nota
    var contador = 0;
    var i = 0
...
function fibonacci (){
    var quantidadeFibonacci = Number(prompt ('Informe a quantidade de números da sequência de Fibonacci'));
    var i = 0;
    var numero1 = 0;
    var numero2 = 1;
    var numero3 = 0;
...
function somatorio(){
    var n = Number(prompt("Informe a quantidade de números:"));
        var num;
        var Soma = 0;
        var i = 0;
